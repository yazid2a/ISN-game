...
GamePanel gp;
	...
	public void setObject() {
		...
		gp.obj[i].worldX=gp.titleSize*30;
		gp.obj[i].worldY=gp.titleSize*15;
		i++;
		gp.obj[i]=new OBJ_Key(gp);
		gp.obj[i].worldX=gp.titleSize*24;
		gp.obj[i].worldY=gp.titleSize*41;
		i++;
		gp.obj[i]=new OBJ_Key(gp);
		gp.obj[i].worldX=gp.titleSize*39;
		gp.obj[i].worldY=gp.titleSize*36;
		i++;

		gp.obj[i]=new OBJ_Axe(gp);
		gp.obj[i].worldX=gp.titleSize*37;
		gp.obj[i].worldY=gp.titleSize*9;
		i++;
		...
		gp.obj[i].worldX=gp.titleSize*8;
		gp.obj[i].worldY=gp.titleSize*28;
		i++;
		gp.obj[i]=new OBJ_Door(gp);
		gp.obj[i].worldX=gp.titleSize*12;
		gp.obj[i].worldY=gp.titleSize*23;
		i++;
		gp.obj[i]=new OBJ_Door(gp);
		gp.obj[i].worldX=gp.titleSize*10;
		gp.obj[i].worldY=gp.titleSize*12;
		i++;
		gp.obj[i]=new OBJ_Chest(gp);
		gp.obj[i].worldX=gp.titleSize*10;
		gp.obj[i].worldY=gp.titleSize*10;
		i++;
